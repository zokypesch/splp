...
// Configuration - simplified structure
$config = [
    'kafka' => [
...
/**
 * Service Handler - implements RequestHandlerInterface like SPLP-Go and SPLP-Bun
 */
class ServiceHandler implements RequestHandlerInterface
{
    public function handle(string $requestId, mixed $payload): mixed
    {
        ...
        try {
            ...
            throw $e; // Re-throw to be handled by MessagingClient
        }
    }
...
try {
    echo "🚀 SPLP-PHP Production Listener Starting...\n";
    echo "📡 Configuration:\n";
    ...
    echo "   - Architecture: Compatible with SPLP-Go & SPLP-Bun\n\n";
